            ...
            <section class="about-us-content">
                <div class="left-container">
                    <div class="about-content">
                        ...
                        <h2 class="higlights">Resort Highlights</h2>
                        <ul>
                            <li>Modern amenities with a touch of classic charm.</li>
                            <li>Sustainable practices and environmental responsibility.</li>
                            <li>Exceptional service tailored to your needs.</li>
                        ...
                        <h2 class="conclusion"> Your Gateway to Unforgettable Bliss! 
